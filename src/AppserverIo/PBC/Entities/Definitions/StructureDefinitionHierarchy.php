...
/**
 * AppserverIo\PBC\Entities\Definitions\StructureDefinitionHierarchy
 *
 * NOTICE OF LICENSE
 *
...
class StructureDefinitionHierarchy
{
     ...
     *
     * @param \AppserverIo\PBC\Interfaces\StructureDefinitionInterface $node The structure definition to insert
     *
     * @return bool
     */
