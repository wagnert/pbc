...
namespace AppserverIo\PBC;

use AppserverIo\PBC\CacheMap;
use AppserverIo\PBC\StructureMap;
use AppserverIo\PBC\Exceptions\GeneratorException;
use AppserverIo\PBC\Entities\Definitions\ClassDefinition;
use AppserverIo\PBC\Entities\Definitions\InterfaceDefinition;
...
use AppserverIo\PBC\Entities\Definitions\Structure;
use AppserverIo\PBC\Parser\StructureParserFactory;
...
{
    /**
     * @var \AppserverIo\PBC\CacheMap $cacheMap A cacheMap instance to organize our cache
     */
    protected $cacheMap;

    /**
     * @var \AppserverIo\PBC\StructureMap $structureMap A structureMap instance to organize the known structures
     */
     ...
     * Default constructor
     *
     * @param \AppserverIo\PBC\StructureMap $structureMap A structureMap instance to organize the known structures
     * @param \AppserverIo\PBC\CacheMap     $cache        A cacheMap instance to organize our cache
    ...
    protected function appendFilter(
        ...
        stream_filter_register('SkeletonFilter', 'AppserverIo\PBC\StreamFilters\SkeletonFilter');
        ...
        if (isset($levelArray[0]) && $levelArray[0] == 1) {
            ...
            if ($filterNeeded) {
                ...
                stream_filter_register('PreconditionFilter', 'AppserverIo\PBC\StreamFilters\PreconditionFilter');
                stream_filter_append(
                    $res,
                    'PreconditionFilter',
                    STREAM_FILTER_WRITE,
        ...
        if (isset($levelArray[1]) && $levelArray[1] == 1) {
            ...
            if ($filterNeeded) {
                ...
                stream_filter_register('PostconditionFilter', 'AppserverIo\PBC\StreamFilters\PostconditionFilter');
                stream_filter_append(
                    $res,
                    'PostconditionFilter',
                    STREAM_FILTER_WRITE,
        ...
        if (isset($levelArray[2]) && $levelArray[2] == 1) {
            ...
            if ($structureDefinition->getInvariants()->count(true) !== 0) {
                ...
                stream_filter_register('InvariantFilter', 'AppserverIo\PBC\StreamFilters\InvariantFilter');
        ...
        stream_filter_register('ProcessingFilter', 'AppserverIo\PBC\StreamFilters\ProcessingFilter');
