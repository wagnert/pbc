...
{
    /**
     * @var \AppserverIo\PBC\Config $config The configuration we base our actions on
     */
    protected $config;

    /**
     * @var \AppserverIo\PBC\CacheMap $cache Cache map to keep track of already processed files
     */
    protected $cache;

    /**
     * @var \AppserverIo\PBC\Generator $generator Generator instance if we need to create a new definition
     */
    protected $generator;
     ...
     *
     * @return \AppserverIo\PBC\StructureMap
     */
    ...
    public function loadClass($className)
    {
        ...
        if ((strpos($className, 'AppserverIo\PBC') === 0 && strpos($className, 'AppserverIo\PBC\Tests') === false) ||
