...
use AppserverIo\PBC\Exceptions\CacheException;
use AppserverIo\PBC\Exceptions\ParserException;
use AppserverIo\PBC\Interfaces\MapInterface;
use AppserverIo\PBC\Utils\Formatting;
...
class StructureMap implements MapInterface
{
    ...
    /**
     * @var \AppserverIo\PBC\Config $config Configuration
     */
    protected $config;
     ...
     *
     * @param \AppserverIo\PBC\Entities\Definitions\Structure $structure The structure to add
     *
     * @return bool
     */
     ...
     *
     * @param \AppserverIo\PBC\Entities\Definitions\Structure|null $structure The structure to update
     *
     * @return void
     *
     ...
     * @param string $identifier The identifier of the entry we try to find
     *
     * @return boolean|\AppserverIo\PBC\Entities\Definitions\Structure
     */
     ...
     * @throws \Exceptions|\AppserverIo\PBC\Exceptions\ParserException
     */
