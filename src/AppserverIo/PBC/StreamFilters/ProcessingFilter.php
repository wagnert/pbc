...
/**
 * AppserverIo\PBC\StreamFilters\ProcessingFilter
 *
 * NOTICE OF LICENSE
 *
...
use AppserverIo\PBC\Exceptions\ExceptionFactory;
    ...
    private function generateCode($config, $for)
    {
        ...
        switch ($config['processing']) {
            ...
            case 'logging':
                ...
                // Create the code
                $code .= '$container = new \AppserverIo\PBC\Utils\InstanceContainer();
