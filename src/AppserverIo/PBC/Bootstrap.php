...
/**
 * src/TechDivision/PBC/Bootstrap.php
 *
 * NOTICE OF LICENSE
 *
...
$loader->add('AppserverIo\\PBC\\', $vendorDir . DIRECTORY_SEPARATOR . 'appserver-io/pbc/src');

// We have to register our autoLoader to put our proxies in place
$autoLoader = new AppserverIo\PBC\AutoLoader();
$autoLoader->register();
