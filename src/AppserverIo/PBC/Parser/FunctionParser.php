...
/**
 * AppserverIo\PBC\Parser\FunctionParser
 *
 * NOTICE OF LICENSE
 *
...
use AppserverIo\PBC\Entities\Definitions\ParameterDefinition;
...
use AppserverIo\PBC\Entities\Lists\ParameterDefinitionList;
...
class FunctionParser extends AbstractParser
{
     ...
     *
     * @return boolean|\AppserverIo\PBC\Entities\Lists\FunctionDefinitionList
     */
     ...
     * @param boolean $getRecursive Do we have to get the ancestral contents as well?
     *
     * @return boolean|\AppserverIo\PBC\Entities\Definitions\FunctionDefinition
     */
     ...
     *
     * @return \AppserverIo\PBC\Entities\Definitions\FunctionDefinition
     */
     ...
     *
     * @param \AppserverIo\PBC\Entities\Definitions\FunctionDefinition $functionDefinition The function definition
     *                                                                                      we are working on
     *
     * @return void
     */
     ...
     * @param array $tokens The token array
     *
     * @return \AppserverIo\PBC\Entities\Lists\ParameterDefinitionList
     *
