...
/**
 * AppserverIo\PBC\Parser\ClassParser
 *
 * NOTICE OF LICENSE
 *
...
use AppserverIo\PBC\Interfaces\StructureParserInterface;
...
class ClassParser extends AbstractStructureParser
{
     ...
     * @param bool        $getRecursive Do we have to get the ancestral conditions as well?
     *
     * @return bool|\AppserverIo\PBC\Interfaces\StructureDefinitionInterface
     */
     ...
     *
     * @return \AppserverIo\PBC\Interfaces\StructureDefinitionInterface
     */
     ...
     *
     * @param \AppserverIo\PBC\Entities\Definitions\ClassDefinition $classDefinition The class definition we have to
