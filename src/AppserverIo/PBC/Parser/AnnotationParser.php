...
/**
 * AppserverIo\PBC\Parser\AnnotationParser
 *
 * NOTICE OF LICENSE
 *
...
use AppserverIo\PBC\Entities\Assertions\RawAssertion;
use AppserverIo\PBC\Entities\Assertions\TypedCollectionAssertion;
use AppserverIo\PBC\Entities\Definitions\AttributeDefinition;
...
use AppserverIo\PBC\Entities\Assertions\ChainedAssertion;
use AppserverIo\PBC\Config;
use AppserverIo\PBC\Exceptions\ParserException;
use AppserverIo\PBC\Interfaces\AssertionInterface;
...
class AnnotationParser extends AbstractParser
{
     ...
     *
     * @return boolean|\AppserverIo\PBC\Entities\Lists\AssertionList
     */
        ...
        switch ($usedAnnotation) {
            ...
            case '@return':
                ...
                if ($type !== false && !empty($type)) {
                    ...
                    $assertionType = 'AppserverIo\PBC\Entities\Assertions\TypeAssertion';
                    ...
                    $type = $class;
                    $assertionType = 'AppserverIo\PBC\Entities\Assertions\InstanceAssertion';
     ...
     *
     * @return \AppserverIo\PBC\Entities\Assertions\ChainedAssertion
     */
     ...
     *
     * @param \AppserverIo\PBC\Interfaces\AssertionInterface $assertion The assertion we need the context for
     *
     * @return void
     */
     ...
     * This information will be entered into the assertion which will then be returned.
     *
     * @param \AppserverIo\PBC\Interfaces\AssertionInterface $assertion The assertion we need the minimal scope for
     *
     * @return void
     */
